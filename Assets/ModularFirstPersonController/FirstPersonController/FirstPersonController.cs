...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        // Attempt to find InventoryManager in the scene
        ...
        // Attempt to find ShopUIManager in the scene
        shopUIManager = GameObject.FindObjectOfType<ShopUIManager>();

        if (shopUIManager == null)
        {
            Debug.Log("[Vice] ShopUIManager not found in the scene!");
        }
    ...
    private void Update()
    {
        ...
        if (cameraCanMove && inventoryManager != null && shopUIManager != null &&
        !inventoryManager.isInventoryOpen && !shopUIManager.IsShopOpen())
        {
            ...
            // Clamp pitch between -maxLookAngle and maxLookAngle
